...
class CykJobs:
    ...
    def add_job(self, cell_rule):
        self.jobs.append(cell_rule)
...
class Worker:
    def __init__(self, jobs_queue, cyk_jobs_queue):
...
def __create_evaluation(cyk_values: CykValues, sentence, result: float) -> SingleExampleEvaluation:
    ...
    evaluation.grammar = cyk_values.grammar
    return evaluation
